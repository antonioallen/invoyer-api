 ...
 */
public class ChatAdapter extends ArrayAdapter<InvoyerMessage> {
    private final Context context;
    private LayoutInflater inflater;
    private List<InvoyerMessage> values;
    private Set<String> onlineNow = new HashSet<String>();

    public ChatAdapter(Context context, List<InvoyerMessage> values) {
    ...
    class ViewHolder {
        ...
        TextView timeStamp;
        View userPresence;
        InvoyerMessage chatMsg;
    }

    @Override
    public View getView(final int position, View convertView, ViewGroup parent) {
        InvoyerMessage chatMsg = this.values.get(position);
        ViewHolder holder;
        if (convertView == null) {
        ...
        holder.user.setText(chatMsg.getSenderId());
     ...
     */
    public void addMessage(InvoyerMessage chatMsg){
     ...
     */
    public void setMessages(ArrayList<InvoyerMessage> chatMsgs){
        this.values.clear();
