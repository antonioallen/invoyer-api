...
public class Invoyer implements InvoyerInterface{
    ...
    public void sendMessage(String TYPE, String message) {
        InvoyerMessage invoyMsg = new InvoyerMessage(userA, message, nextMessageId(), System.currentTimeMillis());
        try {
                            ...
                            if (jsonObj != null){
                                if (jsonObj.has("type")) { // Checking if object has type
                                    if (jsonObj.getString("type").contains(InvoyerConstants.JSON_TYPE_DM)) {
                                        ...
                                        InvoyerMessage invoyerMsg = new InvoyerMessage(userId, msg, msgId, time);
                    ...
                    try {
                        ...
                        if (jsonObj.has("type")){ // Checking if object has type
                            if (jsonObj.getString("type").contains(InvoyerConstants.JSON_TYPE_DM)){
                                ...
                                final InvoyerMessage invoyerMsg = new InvoyerMessage(userId, msg, msgId,time);
